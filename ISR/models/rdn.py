...
WEIGHTS_URLS = {
    ...
    'psnr-large': {
        ...
        'name': 'sr_models/psnr_large/rdn-C6-D20-G64-G064-x2_PSNR_epoch086.hdf5'
    ...
    'psnr-small': {
        ...
        'name': 'sr_models/psnr_small/rdn-C3-D10-G64-G064-x2_PSNR_epoch134.hdf5',
    ...
    'noise-cancel': {
        ...
        'name': 'sr_models/noise_cancel/rdn-C6-D20-G64-G064-x2_ArtefactCancelling_epoch219.hdf5',
    }
}
